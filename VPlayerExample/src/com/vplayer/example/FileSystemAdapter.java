...
import com.vplayer.example.FileSystemAdapter.FileListItem;
...
public class FileSystemAdapter extends ViewAdapterBase<FileListItem> {
    ...
    public FileSystemAdapter(Context context, File startDirectory, boolean showBackButton,
        ...
        IconBackDrawable = context.getResources().getDrawable(R.drawable.ic_folder_up_light);
        IconFileDrawable = context.getResources().getDrawable(R.drawable.ic_video_file_light);
        IconFolderDrawable = context.getResources().getDrawable(R.drawable.ic_folder_light);
    ...
    public boolean refresh() {
        File[] files = mCurrentDirectory.listFiles(new FileFilter() {      // TODO split this into file and folder
            ...
            public boolean accept(File file) {
                boolean accept =  (!mOnlyShowFolders && (!file.isHidden() || file.isHidden()
                        && mShowHidden)) || file.isDirectory();
                if (accept && mFilter != null) {
                    accept = mFilter.accept(file);
                }
                return accept;
            }
        });
